...
return [
    ...
    | oleh kelas validator. Beberapa aturan mempunyai banyak versi seperti
    | aturan 'size'. Silakan ubah setiap pesan yang ada di sini.
    |
    */
    ...
    | Hal ini mempercepat penentuan baris bahasa kustom yang spesifik untuk
    ...
    */
    ...
    'custom' => [
        'phone' => [
            'regex' => 'Format nomor telepon tidak valid. Gunakan format yang benar.',
        ],
        'email' => [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut ini digunakan untuk mengganti placeholder atribut
